...
void LearnStochastic::learn_batch2(const std::vector<std::vector<int>> &obs, 
...
void LearnStochastic::learn_stochastic2(const std::vector<std::vector<int> > &obs,
                      const std::vector<std::function<bool(std::vector<int> &)> > &constraintOracle,
                      const Options &options)
{
    ...
    learn_batch2(obs, constraintOracle, generator, options);
}

void LearnStochastic::learn_stochastic2(const std::vector<int> &obs,
                      ...
                      const Options &options)
{
    ...
    learn_stochastic2(newobs, newconstraintoracle, options);
}

void LearnStochastic::learn_hardEM2(const std::vector<std::vector<int> >& obs,
                  const std::vector<std::function<bool(std::vector<int>&)> >& constraintoracle,
...
void LearnStochastic::learn_hardEM2(const std::vector<int>& obs,
                  const std::function<bool(std::vector<int>&)>& constraintoracle,
                  const int numsolns, const Options& options)
{
    std::vector<std::vector<int> > newobs;
    ...
    std::vector<std::function<bool(std::vector<int>&)> > newconstraintoracle;
    newconstraintoracle.push_back(constraintoracle);
    learn_hardEM2(newobs, newconstraintoracle, numsolns, options);
}
