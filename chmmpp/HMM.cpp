...
// linear constraints
std::vector<int> HMM::aStar(const std::vector<int> &observations, double &logProb,
...
std::vector<int> HMM::aStarOracle(
...
std::vector<std::vector<int> > HMM::aStarMult(const std::vector<int> &observations, double &logProb,
...
std::vector<std::vector<int> > HMM::aStarMult(
    const std::vector<int> &observations, double &logProb,
...
void HMM::learn(const std::vector<std::vector<int> > &obs, const std::vector<int> &numZeros,
                const double eps)
{
    int T = obs[0].size();
    size_t R = obs.size();
...
void HMM::learn(const std::vector<std::vector<int> > &obs,
...
void HMM::learnHard(const std::vector<std::vector<int> > &obs,
                    const std::vector<std::function<bool(std::vector<int>)> > &constraintOracle,
